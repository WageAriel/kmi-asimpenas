    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 flex items-center justify-center px-8 bg-white">
            <div class="w-full max-w-sm">
                ...
                <div v-if="form.errors.email && form.errors.email.includes('dinonaktifkan')" class="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div class="flex items-start">
                        <svg class="w-5 h-5 text-yellow-600 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                        </svg>
                        <div class="flex-1">
                            <h3 class="text-sm font-semibold text-yellow-800 mb-1">Akun Tidak Aktif</h3>
                            <p class="text-sm text-yellow-700 mb-3">{{ form.errors.email }}</p>
                            <Link 
                                :href="route('register')" 
                                class="inline-flex items-center px-3 py-1.5 bg-yellow-600 hover:bg-yellow-700 text-white text-sm font-medium rounded-md transition-colors"
                            >
                                Daftar Akun Baru
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div>
                        ...
                        />
                        <div v-if="form.errors.email && !form.errors.email.includes('dinonaktifkan')" class="mt-1 text-sm text-red-600">
                            {{ form.errors.email }}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            >
                                <!-- Hide Password Icon (when password is visible) -->
