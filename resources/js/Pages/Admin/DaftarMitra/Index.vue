...
const bulkDelete = async () => {
    ...
    try {
        await axios.post('/admin/daftar-mitra/bulk-delete', {
...
const samaDenganCPAdmin = ref(false);
...
const updateMitra = async () => {
    ...
    try {
        ...
        setTimeout(() => {
            router.visit(route('admin.daftar-mitra.index'), {
...
// Delete functions
const openSingleDeleteModal = (mitra) => {
...
const deleteMitra = async () => {
    ...
    try {
        await axios.delete(`/admin/daftar-mitra/${mitraToDelete.value.id_mitra}`);
                            ...
                            <tr v-for="mitra in paginatedMitras" :key="mitra.id_mitra" class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="flex space-x-2">
                                        ...
                                        <button
                                            @click="openSingleDeleteModal(mitra)"
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <input
                                            type="checkbox"
                                            id="edit_sama_dengan_cp"
                                            v-model="samaDenganCPAdmin"
                                        ...
                                        />
                                        <label for="edit_sama_dengan_cp" class="ml-2 text-sm text-gray-600">
                                    ...
                                    <input
                                        ...
                                        :readonly="samaDenganCPAdmin"
                                        :class="[
                                            'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                                            samaDenganCPAdmin ? 'bg-gray-100 cursor-not-allowed' : ''
                                        ]"
            ...
            <div class="bg-white rounded-xl shadow-lg max-w-md w-full p-6 relative" @click.stop>
                ...
                <div class="text-center">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        ...
                        <span class="font-bold text-gray-900">{{ mitraToDelete?.nama_perusahaan }}</span>?
                        <br>
                    ...
                    <div v-if="deleteError" class="bg-red-50 border border-red-200 rounded-lg p-3 mb-4">
                        <div class="flex items-center justify-center">
                            ...
                            <p class="ml-2 text-sm font-medium text-red-800">{{ deleteError }}</p>
                        </div>
                    </div>
