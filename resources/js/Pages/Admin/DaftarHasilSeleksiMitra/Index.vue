...
// Get unique years from hasil seleksi mitras
const availableYears = computed(() => {
    const years = hasilSeleksiMitras.value.map(item => {
        if (item.created_at) {
...
// Filter data based on search query and year
const filteredData = computed(() => {
    let filtered = hasilSeleksiMitras.value;
            ...
            <div class="mb-4 flex flex-col sm:flex-row gap-3 items-start sm:items-center">
                ...
                <div class="relative w-full sm:flex-1">
                    ...
                    <input
                        ...
                        placeholder="Cari hasil seleksi mitra..."
                        v-model="searchQuery"
                    />
                    <button 
                        v-if="searchQuery"
                ...
                <div class="flex items-center gap-2 w-full sm:w-auto">
                    <label for="itemsPerPageHasil" class="text-sm text-gray-700 whitespace-nowrap">
                        Tampilkan:
                    </label>
                    <select
                        id="itemsPerPageHasil"
