...
watch(() => form.jenis_komoditas, (newValue) => {
    ...
    // Reset kualitas dan update satuan untuk semua items jika jenis komoditas berubah
                ...
                <div class="bg-white shadow rounded-lg mb-6">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center space-x-4">
                            <button 
                                @click="$inertia.visit(route('admin.purchase-orders.show', purchaseOrder.id))"
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            ...
                            <div v-for="(item, index) in form.kualitas_items" :key="index" class="mb-6 p-4 border border-gray-200 rounded-lg">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    <!-- Harga -->
                                    <div>
                                        <InputLabel :for="`harga_${index}`" :value="`Harga (Rp/${item.satuan})`" />
                                    ...
                                    <!-- Kuantum -->
                                    <div>
                                        <InputLabel :for="`kuantum_${index}`" :value="`Kuantum (${item.satuan})`" />
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input
                                                :id="`kuantum_${index}`"
                                                type="text"
