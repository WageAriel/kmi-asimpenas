...
const deletePO = () => {
    if (selectedPO.value) {
        router.delete(route('super-admin.purchase-orders.destroy', selectedPO.value.id), {
            onSuccess: () => {
...
const applyFilter = () => {
    router.get(route('super-admin.purchase-orders.index'), {
                ...
                <div class="bg-white shadow rounded-lg mb-6">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex justify-between items-center">
                            ...
                            <Link 
                                :href="route('super-admin.purchase-orders.create')"
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total Kuantum (Kg)</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="(po, index) in purchaseOrders.data" :key="po.id" class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        <Link 
                                            :href="route('super-admin.purchase-orders.show', po.id)"
                                            class="text-blue-600 hover:text-blue-900"
                                        >
                                            Lihat
                                        </Link>
                                        <Link 
                                            :href="route('super-admin.purchase-orders.edit', po.id)"
