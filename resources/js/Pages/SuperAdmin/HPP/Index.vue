...
const submitForm = async () => {
    ...
    try {
        if (modalMode.value === 'create') {
            await axios.post('/super-admin/hpp', form.value);
            successMessage.value = 'Data HPP berhasil ditambahkan';
        } else {
            await axios.put(`/super-admin/hpp/${selectedDocument.value.id}`, form.value);
...
const confirmDelete = async () => {
    ...
    try {
        await axios.delete(`/super-admin/hpp/${selectedItemToDelete.value.id}`);
...
const toggleActive = async (id) => {
    try {
        const response = await axios.patch(`/super-admin/hpp/${id}/toggle-active`);
...
<template>
    <Head title="Manajemen HPP - Super Admin" />
        ...
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <button
                    ...
                    class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium shadow-sm"
                >
            ...
            <div class="space-y-6">
                ...
                <div v-if="sortedDocuments.length === 0" class="text-center py-12 bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <button
                        @click="openCreateModal"
                        class="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium text-sm"
                    >
                        Tambah Data Pertama
                    </button>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-lg max-w-4xl w-full mx-4 my-8 max-h-[90vh] overflow-y-auto">
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <select v-model="form.jenis_hpp" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="Contoh: GKP"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-white"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="Contoh: Gudang Bulog"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-white"
                                    />
                                </div>
                            </div>
