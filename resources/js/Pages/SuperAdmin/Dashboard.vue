...
onMounted(() => {
    ...
    console.log('Super Admin Dashboard loaded with stats:', stats.value);
});
</script>

<template>
    <Head title="Dashboard Super Admin - ASIMPENAS" />
    ...
    <SuperAdminLayout>
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600">Overview lengkap sistem ASIMPENAS</p>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-semibold">{{ stats.total_admin }}</p>
                        </div>
                    </div>
                </div>
