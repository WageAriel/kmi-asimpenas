...
import { HomeIcon, UsersIcon, DocumentIcon, ClipboardDocumentCheckIcon, DocumentChartBarIcon, DocumentCheckIcon, ShoppingCartIcon, CurrencyDollarIcon } from '@heroicons/vue/24/outline';
...
const menuItems = [
    ...
    {
        name: 'Daftar User',
        route: 'super-admin.daftar-user.index',
        icon: UsersIcon
    },
    {
        name: 'Daftar Mitra',
        route: 'super-admin.daftar-mitra.index',
        icon: DocumentIcon
    },
    {
        name: 'Daftar Seleksi Mitra',
        route: 'super-admin.seleksi-mitra.index',
        icon: ClipboardDocumentCheckIcon
    },
    {
        name: 'Daftar Klasifikasi Mitra',
        route: 'super-admin.klasifikasi-mitra.index',
                    ...
                    <div class="flex items-center flex-shrink-0 px-4 py-2">
                        <Link href="/" class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Portal Super Admin</p>
                            </div>
                        </Link>
                    </div>
        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
            ...
            <div class="lg:hidden">
                <div class="flex items-center justify-between bg-white border-b border-gray-200 px-4 py-2">
                    ...
                    <h1 class="text-lg font-semibold text-gray-900">ASIMPENAS Portal Super Admin</h1>
                    <div></div>
                </div>
            </div>
