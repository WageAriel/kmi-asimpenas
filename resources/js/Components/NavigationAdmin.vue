...
import { HomeIcon, UsersIcon, DocumentIcon, ClipboardDocumentCheckIcon, DocumentChartBarIcon, DocumentCheckIcon, ShoppingCartIcon, BanknotesIcon } from '@heroicons/vue/24/outline';
