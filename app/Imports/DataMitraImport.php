...
class DataMitraImport implements ToModel, WithHeadingRow, WithValidation, SkipsEmptyRows, SkipsOnError, SkipsOnFailure
{
    ...
    public function model(array $row)
    {
        ...
        return new DataMitra([
            ...
            'nama_yang_dikuasakan' => $row['nama_yang_dikuasakan'] ?? null,
            'nik_yang_dikuasakan' => $this->formatNumericString($row['nik_yang_dikuasakan'] ?? null),
            'alamat_yang_dikuasakan' => $row['alamat_yang_dikuasakan'] ?? null,
